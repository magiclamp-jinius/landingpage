export default function Footer() {
  return (
    <footer className="bg-[#0D174B] py-12">
      <div className="container mx-auto px-4 text-center">
        <p className="text-white font-extrabold text-xl mb-2">지니어스컴퍼니</p>
        ...
        <div className="flex justify-center gap-6 text-white/40 text-xs mb-8">
          ...
          <a href="#contact" className="hover:text-white/70 transition-colors">문의하기</a>
        </div>
